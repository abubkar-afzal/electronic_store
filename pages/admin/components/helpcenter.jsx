...
const AdminHelpCenter=()=>{
    return(<>
        <div className="l:grid l:grid-cols-2 l:h-[25rem] ">
            <div className="w-full h-[50%]  bg-[var(---blacktext)] text-[var(---whitetext)] flex flex-col items-center l:justify-center">
                ...
                <div className="w-full l:w-[65%] l:justify-start px-[4rem]"> <Link href={`/admin/components/basic/helpcenter`}><button className="p-2 l:text-[18px] l:w-[50%]  py-3 bg-[var(---whitetext)] w-full text-[var(---btncolor)] rounded-[1.5rem] my-4 mb-[2rem] hover:bg-[var(---btncolor)] hover:text-[var(---whitetext)] duration-[1s] cursor-pointer ">Go to Help Center</button></Link></div>
            </div>
            <div>
