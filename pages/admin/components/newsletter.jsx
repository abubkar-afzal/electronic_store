      ...
      <div className="w-full bg-[var(---btncolor)] text-[var(---whitetext)] flex flex-col items-center py-[1rem] my-[1rem]">
        ...
        <div className="mt-[3rem] l:mt-[1rem] w-full px-4 l:items-center l:flex l:justify-center l:flex-col">
          ...
          <div className="l:flex l:items-center l:w-[60%]">
            <input
              type="email"
              className="outline w-full l:w-[70%] text-[20px] p-2 rounded-[2rem] my-[1rem]"
            />

            <div className="w-full px-[1rem] l:w-[30%]">
              <button className="bg-[var(---blacktext)] w-full py-3 font-thin rounded-[2rem] cursor-pointer hover:bg-[var(---hoverbtncolor)] hover:text-[var(---blacktext)]">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="flex items-center space-x-2 text-[14px] font-semibold w-full px-4 text-[var(---warningred)] mb-[2rem] l:w-[60%]">
          <RiErrorWarningLine />
          <div>Check the box to continue.</div>
        </div>
      </div>
    </>
  );
