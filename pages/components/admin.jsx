...
import adminimage from "../components/assets/login.png";
        ...
        >
          ...
          <>
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center p-4 sm:bg-transparent l:bg-[var(---whitetext)] sm:pt-[5rem] l:pt-[8rem]">
