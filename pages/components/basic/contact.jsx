...
const Contact=()=>{
    ...
    <div className="flex flex-col items-center justify-center p-4 bg-[var(---whitetext)]">
            <div className="text-[2rem] font-sans font-bold">Get in Touch</div>
            <div className="my-[2rem] border-t-[1px] py-[1rem]">
              ...
              <div className="text-center mb-[2rem]">
                ...
                <form action="post" className="w-full">
                  ...
                  <div className="px-[1rem] my-[1rem]">
                    <div htmlFor="Subject" className="font-thin">Subject*</div>
                    <input
                      type="text"
                      id="Subject"
                      name="Subject"
                  ...
                  <div className="px-[1rem] my-[1rem]">
                    <div htmlFor="Resume" className="font-thin">Leave us a message...</div>
                    <textarea
                      type="text"
                      id="Resume"
                      name="Resume"
                ...
                <div className="flex flex-col items-center px-[4rem] py-[2rem]">
                        ...
                        <div className="flex flex-col items-center px-[4rem] py-[2rem]">
                                 <div className="text-[18px] font-bold my-[1rem]">Opening Hours</div>
                                 <div className="text-[13px] font-thin text-center my-1 cursor-pointer">Mon - Fri: 8:00 AM - 8:00 PM
                                 </div>
                                 <div className="text-[13px] font-thin text-center my-1 cursor-pointer">
