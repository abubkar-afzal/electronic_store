    ...
    <>
      <div className="sm:block l:hidden mx-[1rem]">
        <div className="flex space-x-2">
          ...
          <div className="">&gt;</div>
          <div className="font-thin">Headphones & Speakers</div>
        </div>
        <div className="text-[30px] font-bold my-[1rem] ">Headphones & Speakers</div>
      ...
      <div className="sm:hidden mx-[1.5rem] l:grid l:grid-cols-5 gap-[10px] ">
        ...
        <div className="col-span-4 h-[100vh] overflow-scroll scrollbar-hide">
          <div className="text-[50px] font-bold my-[1rem] ">Headphones & Speakers</div>
