...
const WearableTech = ({addToCart}) => {
  const pageName = "Wearable Tech";
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("/api/viewwearabletech");
  ...
  const imageUrl = `${siteUrl}wearable.png`;
  return (
    <>
    <Head>
  <title>AR Codes - Wearable Tech Page</title>
  ...
  <meta property="og:url" content={`${siteUrl}components/category/wearabletech`} />
  ...
  <link rel="canonical" href={`${siteUrl}components/category/wearabletech`} />
