...
const Sale = ({addToCart}) => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("/api/viewsale");
  ...
  const imageUrl = `${siteUrl}sale.png`;
  return (
    <>
    <Head>
  <title>AR Codes - Sales Page</title>
  ...
  <meta property="og:url" content={`${siteUrl}components/category/sale`} />
  ...
  <link rel="canonical" href={`${siteUrl}components/category/sale`} />
