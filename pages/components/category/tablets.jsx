...
const Tablets = ({addToCart}) => {
  ...
  const imageUrl = `${siteUrl}tablet.png`;
  return (
    <>
    <Head>
  <title>AR Codes - Tablets Page</title>
  ...
  <meta property="og:url" content={`${siteUrl}components/category/tablets`} />
  ...
  <link rel="canonical" href={`${siteUrl}components/category/tablets`} />
