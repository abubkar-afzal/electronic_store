...
const TVAndHomeCinema = ({addToCart}) => {
  const pageName = "TV & Home Cinema";
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("/api/viewtv&homecinema");
  ...
  const imageUrl = `${siteUrl}tv.png`;
  return (
    <>
    <Head>
  <title>AR Codes - T.V & Home Cinema Page</title>
  ...
  <meta property="og:url" content={`${siteUrl}components/category/tv&homecinema`} />
  ...
  <link rel="canonical" href={`${siteUrl}components/category/tv&homecinema`} />
