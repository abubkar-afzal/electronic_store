...
const BestSeller = ({addToCart}) => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("/api/viewbestseller");
  ...
  const imageUrl = `${siteUrl}bestseller.jpeg`;
  return (
    <>
    <Head>
  <title>AR Codes - Best Seller Page</title>
  ...
  <meta property="og:url" content={`${siteUrl}components/category/bestseller`} />
  ...
  <link rel="canonical" href={`${siteUrl}components/category/bestseller`} />
