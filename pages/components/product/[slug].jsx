  ...
  return (
    <>
      {product.map((product) => (
        <>
          <div className="l:px-[10rem] sm:px-[2rem] flex space-x-2 text-[18px] mb-[1rem]">
            ...
            <div className="font-thin sm:hidden l:block">{product?.name || "Product"}</div>
          </div>
          ...
          >
            ...
            <div className="">
              ...
              <div className="flex flex-col l:items-start sm:items-center ">
                <button className="text-[16px] l:text-[16px] font-semibold bg-[var(---btncolor)] text-[var(---whitetext)]  p-4 sm:w-[90vw] l:w-auto l:px-[5rem] rounded-[8px] my-[1rem] cursor-pointer hover:bg-transparent hover:text-[var(---btncolor)] hover:border-[var(---btncolor)] hover:border-[1px] duration-[1s]">
                  Add to Cart
                </button>
      ...
      <div className=" l:px-[5rem] my-[2rem]">
        <div className=" sm:mx-[5rem] text-[25px] font-bold">You might also like</div>
